 ...
 *  protocol will immediately become a view that requires dirty invalidation
 *  prior to updating (i.e. calling setNeedsUpdate). This protocol supports
 *  forwarding/blocking update methods to/fro subviews/superview respectively,
 *  both of which are disabled by default. Note that in order for update method
 *  forwarding/blocking to work properly, the corresponding subview/superview
